...
const results = {
  ...
  "001": "You should work on some chores.",
  "010": "You should watch some TV or go on YouTube.",
  "100": "You should listen to some programming-related podcasts.",
  "110": "You should read an Instapaper article or a graphic novel.",
  "101": "You should listen to programming podcasts or do some chores.",
